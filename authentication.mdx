...
description: "How to authenticate your requests to the ShardCloud API."
---
...
Your `session_token` is obtained after logging in via Discord OAuth2 on the [ShardCloud Dashboard](https://shardcloud.app).
